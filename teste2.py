...
class Register:
    def __init__(self, master: Tk):
        ...
        self.infPessoa = Label(self.frame_widgets, text="Informações Pessoais", bg=intern_bg, relief='groove')
        self.infPessoa.grid(row=0, column=0, columnspan=99, sticky=NSEW)
        ...
        self.lbl_cpf.grid(row=1, column=4, sticky=W, padx=2)
        ...
        self.lbl_rg.grid(row=5, column=4, sticky=W)
        ...
        self.lbl_estado_civil.grid(row=0, column=0, sticky=W)
        estados_civis = (
            'Solteiro (a)', 
            'Casado (a)', 
            'Viúvo (a)', 
        ...
        self.lbl_sexo.grid(row=0, column=0, sticky=W)
        ...
        self.lbl_phone.grid(row=7, column=3, sticky=W, padx=(10, 0))
        self.ent_phone = PhoneEntry(self.frame_widgets)
        self.ent_phone.grid(row=8, column=3, columnspan=2, sticky=EW, padx=(10, 40))

        self.infEnd = Label(self.frame_widgets, text="Informações De Endereço", bg=intern_bg, relief='groove')
        self.infEnd.grid(row=9, column=0, columnspan=99, sticky=NSEW, pady=(5, 0))

        self.lbl_cep = Label(self.frame_widgets, text="CEP: ", bg=intern_bg)
        self.lbl_cep.grid(row=10, column=0, sticky=W)
        ...
        self.lbl_rua.grid(row=10, column=2, sticky=W, padx=10)
        ...
        self.lbl_bairro.grid(row=12, column=0, sticky=W)
        ...
        self.lbl_comp.grid(row=12, column=3, sticky=W, padx=5)
        ...
        self.lbl_num.grid(row=14, column=0, sticky=W)
        ...
        self.lbl_cidade.grid(row=14, column=3, sticky=W, padx=5)
